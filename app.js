...
const $=id=>document.getElementById(id);let p={sep:40,gapA:0,gapB:0,radius:100,az:35,el:15,res:2.6,iterations:30,thresholdKeV:20,energyKeV:1000,rotationA:0,rotationB:0,activityUCi:1000,measurementSeconds:3600,generator:'volume',seed:42},worker,result,records=[],busy=true,timer,roomView;
